...
class Explosion extends PositionComponent with HasGameReference<MyGame> {
  ...
  Explosion({required super.position, required this.explosionType, required this.explosionSize});
      ...
      particle: Particle.generate(
        ...
        generator: (index) {
          return MovingParticle(
            ...
            to: Vector2((_random.nextDouble() - 0.5) * explosionSize * 2, (_random.nextDouble() - 0.5) * explosionSize * 2),
